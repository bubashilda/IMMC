...
for iteration in range(0, 1):
    ...
    count = float(input_s[15 - 1][0 : len(input_s) - 2])


    if (input_s[11 - 1][0] == '1'):
        sort_random(count)
    elif (input_s[11 - 1][0] == '2'):
        sort_sections(1, 3, 2, count)
    elif (input_s[11 - 1][0] == '2'):
        sort_windows(count)
    elif (input_s[11 - 1][0] == '2'):
        sort_piramidka(count)
    elif (input_s[11 - 1][0] == '2'):
        sort_steffen(count)
...
for i in range(0, len(f)):
    ...
    time.sleep(float(input_s[18 - 1][0 : len(input_s) - 2]))
